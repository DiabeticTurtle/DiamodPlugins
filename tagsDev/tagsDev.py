...
class TagsPlugin(commands.Cog):
    ...
    async def dtags(self, ctx: commands.Context):
        """
    ...
    @tags.command()
    async def dadd(self, ctx: commands.Context, name: str, *, content: str):
        """
        Make a new tag
        """
    ...
    @tags.command()
    async def dedit(self, ctx: commands.Context, name: str, *, content: str):
        """
    ...
    @tags.command()
    async def ddelete(self, ctx: commands.Context, name: str):
        """
        Delete a tag.
        Only owner of tag or user with Manage Server permissions can use this command
        """
    ...
    @tags.command()
    async def dclaim(self, ctx: commands.Context, name: str):
        """
    ...
    @tags.command()
    async def dinfo(self, ctx: commands.Context, name: str):
        """
        Get info on a tag
        """
        tag = await self.find_db(name=name)
    ...
    @commands.command()
    async def dtag(self, ctx: commands.Context, name: str):
